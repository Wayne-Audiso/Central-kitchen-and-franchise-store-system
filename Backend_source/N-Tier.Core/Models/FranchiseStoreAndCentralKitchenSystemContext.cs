...
public partial class FranchiseStoreAndCentralKitchenSystemContext : DbContext
{
    public FranchiseStoreAndCentralKitchenSystemContext(DbContextOptions<FranchiseStoreAndCentralKitchenSystemContext> options)
        : base(options)
    {
    }
